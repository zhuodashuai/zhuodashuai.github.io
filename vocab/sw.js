const CACHE_NAME = "zhuo-wordbook-v35";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=35", "./manifest.webmanifest",
  "./js/public-app.js?v=35", "./js/owner-app.js?v=35", "./js/pwa.js", "./js/runtime-config.js",
