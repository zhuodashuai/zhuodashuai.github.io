const CACHE_NAME = "zhuo-wordbook-v39";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=39", "./manifest.webmanifest",
  "./js/public-app.js?v=39", "./js/owner-app.js?v=39", "./js/pwa.js", "./js/runtime-config.js",
