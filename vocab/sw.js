const CACHE_NAME = "zhuo-wordbook-v37";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=37", "./manifest.webmanifest",
  "./js/public-app.js?v=37", "./js/owner-app.js?v=37", "./js/pwa.js", "./js/runtime-config.js",
