const CACHE_NAME = "zhuo-wordbook-v45";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=45", "./manifest.webmanifest",
  "./js/public-app.js?v=45", "./js/owner-app.js?v=45", "./js/pwa.js", "./js/runtime-config.js",
