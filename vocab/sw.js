const CACHE_NAME = "zhuo-wordbook-v41";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=41", "./manifest.webmanifest",
  "./js/public-app.js?v=41", "./js/owner-app.js?v=41", "./js/pwa.js", "./js/runtime-config.js",
