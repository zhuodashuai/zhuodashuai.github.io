const CACHE_NAME = "zhuo-wordbook-v54";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./guide.html", "./styles.css?v=54", "./manifest.webmanifest",
  "./js/public-app.js?v=54", "./js/owner-app.js?v=54", "./js/entry-detail.js", "./js/collections.js", "./js/study.js", "./js/review.js", "./js/pwa.js", "./js/runtime-config.js",
