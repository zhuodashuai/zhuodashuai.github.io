const CACHE_NAME = "zhuo-wordbook-v40";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=40", "./manifest.webmanifest",
  "./js/public-app.js?v=40", "./js/owner-app.js?v=40", "./js/pwa.js", "./js/runtime-config.js",
