const CACHE_NAME = "zhuo-wordbook-v42";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=42", "./manifest.webmanifest",
  "./js/public-app.js?v=42", "./js/owner-app.js?v=42", "./js/pwa.js", "./js/runtime-config.js",
