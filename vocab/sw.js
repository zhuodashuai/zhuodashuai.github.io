const CACHE_NAME = "zhuo-wordbook-v36";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=36", "./manifest.webmanifest",
  "./js/public-app.js?v=36", "./js/owner-app.js?v=36", "./js/pwa.js", "./js/runtime-config.js",
