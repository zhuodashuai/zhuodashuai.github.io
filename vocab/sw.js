const CACHE_NAME = "zhuo-wordbook-v23";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=23", "./manifest.webmanifest",
  "./js/public-app.js?v=23", "./js/owner-app.js?v=23", "./js/pwa.js", "./js/runtime-config.js",
