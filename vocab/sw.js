const CACHE_NAME = "zhuo-wordbook-v52";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./guide.html", "./styles.css?v=52", "./manifest.webmanifest",
  "./js/public-app.js?v=52", "./js/owner-app.js?v=52", "./js/entry-detail.js", "./js/pwa.js", "./js/runtime-config.js",
