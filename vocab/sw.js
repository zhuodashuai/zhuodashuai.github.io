const CACHE_NAME = "zhuo-wordbook-v46";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=46", "./manifest.webmanifest",
  "./js/public-app.js?v=46", "./js/owner-app.js?v=46", "./js/entry-detail.js", "./js/pwa.js", "./js/runtime-config.js",
