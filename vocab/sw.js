const CACHE_NAME = "zhuo-wordbook-v43";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=43", "./manifest.webmanifest",
  "./js/public-app.js?v=43", "./js/owner-app.js?v=43", "./js/pwa.js", "./js/runtime-config.js",
