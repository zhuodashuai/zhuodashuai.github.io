const CACHE_NAME = "zhuo-wordbook-v55";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./guide.html", "./styles.css?v=55", "./manifest.webmanifest",
  "./js/public-app.js?v=55", "./js/owner-app.js?v=55", "./js/entry-detail.js", "./js/collections.js", "./js/study.js", "./js/review.js", "./js/pwa.js", "./js/runtime-config.js",
