const CACHE_NAME = "zhuo-wordbook-v56";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./guide.html", "./styles.css?v=56", "./manifest.webmanifest",
  "./js/public-app.js?v=56", "./js/owner-app.js?v=56", "./js/entry-detail.js", "./js/synonym-groups.js", "./js/synonym-view.js", "./js/collections.js", "./js/study.js", "./js/review.js", "./js/pwa.js", "./js/runtime-config.js",
  "./js/owner-api.js", "./js/owner-storage.js", "./js/sync-logic.js", "./js/wordbook-schema.js", "./js/core-dictionary.js",
