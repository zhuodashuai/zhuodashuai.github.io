const CACHE_NAME = "zhuo-wordbook-v51";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=51", "./manifest.webmanifest",
  "./js/public-app.js?v=51", "./js/owner-app.js?v=51", "./js/entry-detail.js", "./js/pwa.js", "./js/runtime-config.js",
