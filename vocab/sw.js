const CACHE_NAME = "zhuo-wordbook-v44";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=44", "./manifest.webmanifest",
  "./js/public-app.js?v=44", "./js/owner-app.js?v=44", "./js/pwa.js", "./js/runtime-config.js",
