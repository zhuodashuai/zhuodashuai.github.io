const CACHE_NAME = "zhuo-wordbook-v38";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./styles.css?v=38", "./manifest.webmanifest",
  "./js/public-app.js?v=38", "./js/owner-app.js?v=38", "./js/pwa.js", "./js/runtime-config.js",
