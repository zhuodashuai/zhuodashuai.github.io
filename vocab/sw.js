const CACHE_NAME = "zhuo-wordbook-v53";
const CACHE_PREFIX = "zhuo-wordbook-";
const SHELL = [
  "./", "./index.html", "./owner.html", "./guide.html", "./styles.css?v=53", "./manifest.webmanifest",
  "./js/public-app.js?v=53", "./js/owner-app.js?v=53", "./js/entry-detail.js", "./js/pwa.js", "./js/runtime-config.js",
